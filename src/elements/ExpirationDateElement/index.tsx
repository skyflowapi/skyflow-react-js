...
/**
 *  Collect Element for capturing expiration date.
 */
const ExpirationDateElement: FC<SkyflowCollectElementProps> = React.memo(function ExpirationDateElement({ ...props }: SkyflowCollectElementProps) {
